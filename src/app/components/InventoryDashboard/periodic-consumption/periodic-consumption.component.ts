...
export class PeriodicConsumptionComponent implements OnInit {
    ...
    inventoryReceiptItem: InventoryItem[];
    public warehouses: Observable<IWareHouse>

    constructor(
        private fb: FormBuilder,
        private _pcitemService: AccountTransactionTypeService,
        private _pConsumeservice: AccountTransactionTypeService,
        private modalService: BsModalService,
        private _inventoryReceiptService: AccountTransactionTypeService,
