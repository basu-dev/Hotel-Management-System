    ...
    InventoryItemComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                this._inventoryService.post(global_1.Global.BASE_INVENTORY_ENDPOINT,  formData.value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.update:
                ...
                this._inventoryService.put(global_1.Global.BASE_INVENTORY_ENDPOINT,  formData.value.Id,  formData.value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.delete:
                this._inventoryService.delete(global_1.Global.BASE_INVENTORY_ENDPOINT,  formData.value.Id).subscribe(function (data) {
                    if (data == 1) {
