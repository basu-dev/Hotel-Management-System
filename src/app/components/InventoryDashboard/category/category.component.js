        ...
        if (departfrm.valid) {
            switch (this.dbops) {
                case enum_1.DBOperation.create:
                    this._categoryService.post(global_1.Global.BASE_CATEGORY_ENDPOINT, formData._value).subscribe(function (data) {
                        if (data == 1) {
                ...
                case enum_1.DBOperation.update:
                    this._categoryService.put(global_1.Global.BASE_CATEGORY_ENDPOINT, formData._value.Id, formData._value).subscribe(function (data) {
                        if (data == 1) {
                ...
                case enum_1.DBOperation.delete:
                    this._categoryService.delete(global_1.Global.BASE_CATEGORY_ENDPOINT, formData._value.Id).subscribe(function (data) {
                        if (data == 1) {
