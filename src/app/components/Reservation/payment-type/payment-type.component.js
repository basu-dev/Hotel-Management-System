        ...
        if (departfrm.valid) {
            switch (this.dbops) {
                ...
                case enum_1.DBOperation.update:
                    this._paymentTypeService.put(global_1.Global.BASE_PAYMENT_TYPES_ENDPOINT,  formData.value.Id, formData._value).subscribe(function (data) {
                        if (data == 1) {
                ...
                case enum_1.DBOperation.delete:
                    this._paymentTypeService.delete(global_1.Global.BASE_PAYMENT_TYPES_ENDPOINT,  formData.value.Id).subscribe(function (data) {
                        if (data == 1) {
