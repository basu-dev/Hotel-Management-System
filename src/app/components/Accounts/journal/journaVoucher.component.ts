...
export class JournalVouchercomponent implements OnInit {
    ...
    constructor(
        private fb: FormBuilder, private _journalvoucherService: AccountTransactionTypeService
,
        private _accountTransValues: AccountTransactionTypeService, private date: DatePipe,
        ...
        if (journal.valid) {
            ...
            switch (this.dbops) {
                ...
                case DBOperation.delete:
                    this._journalvoucherService.delete(Global.BASE_JOURNALVOUCHER_ENDPOINT, JournalObject.Id).subscribe(
                        data => {
                            if (data == 1) {
